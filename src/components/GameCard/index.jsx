  ...
  render() {
    if(this.props.type === 'flip'){
        ...
        <div className="gamer-profile-card">
            ...
            <h3 className={`gamer-profile-card-text-flip ${this.props.theme === 'dark' ? 'dark-theme-text' : ''} `}>{this.props.text}</h3>
        </div>
        )
    }else{
        return (
            <div className="gamer-profile-card">
                ...
                <h3 className={`gamer-profile-card-text ${this.props.theme === 'dark' ? 'dark-theme-text' : ''} `}>{this.props.text}</h3>
            </div>
        )
    }
  }
